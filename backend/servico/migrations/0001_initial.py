    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('situacao', models.CharField(choices=[('ap', 'Aprovado'), ('pe', 'Pendente'), ('ca', 'Cancelado'), ('an', 'Andamento')], max_length=2, verbose_name='Situação')),
                ('cliente', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ordem_serviços', to='crm.cliente', verbose_name='cliente')),
            ],
            options={
